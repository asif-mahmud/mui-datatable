...
export function useMuiDatatable() {
    ...
    return __assign(__assign({}, rest), { updateColumns: updateColumns, updateOriginalData: updateOriginalData, updatePreparedData: updatePreparedData, updateData: updateData, setVisibleColumns: setVisibleColumns, setLoading: setLoading });
}
