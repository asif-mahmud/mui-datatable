...
export function MuiDatatableTable(_a) {
    ...
    var _c = useMuiDatatable(), columnsConfig = _c.columns, visibleColumns = _c.visibleColumns, data = _c.data, preparedData = _c.preparedData, originalData = _c.originalData, loading = _c.loading;
    ...
    return (React.createElement(TableContainer, __assign({}, tableContainerProps),
        React.createElement(Table, __assign({}, tableProps),
            ...
            React.createElement(TableBody, __assign({}, tableBodyProps),
                !loading &&
                    data.map(function (row, index) { return (React.createElement(TableRow, __assign({ key: index }, valueRowProps), columns.map(function (col) { return (React.createElement(TableCell, __assign({ key: col.property }, valueCellProps, col.valueCellProps),
                        col.renderCell &&
