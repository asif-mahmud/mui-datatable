...
export function useMuiDatatable() {
    ...
    var updatePaginationOptions = function (options) {
        if (dispatch) {
            dispatch({
    ...
    var lastPage = function () {
        if (dispatch) {
            var pageCount = Math.floor(rest.pageMeta.total / rest.pageMeta.pageSize);
            dispatch({
                action: MuiDatatableAction.UpdatePagination,
                payload: {
                    pageMeta: {
    ...
    return __assign(__assign({}, rest), { updateColumns: updateColumns, updateOriginalData: updateOriginalData, updatePreparedData: updatePreparedData, updateData: updateData, setVisibleColumns: setVisibleColumns, setLoading: setLoading, setSearchTerm: setSearchTerm, updatePaginationOptions: updatePaginationOptions, setPageSize: setPageSize, setPage: setPage, nextPage: nextPage, previousPage: previousPage, firstPage: firstPage, lastPage: lastPage });
}
