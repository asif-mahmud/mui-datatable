...
export function useMuiDatatableProcessor({ columns, data, loading, pageSizes = MuiDatatableDefaultPaginationOptions.pageSizes, defaultPageSize = MuiDatatableDefaultPaginationOptions.defaultPageSize, disablePagination = MuiDatatableDefaultPaginationOptions.disablePagination, }) {
    // datatable state
    const [state, dispatch] = useReducer(MuiDatatableReducer, MuiDatatableInitialValue);
    // set loading state
    useEffect(() => {
        dispatch({
