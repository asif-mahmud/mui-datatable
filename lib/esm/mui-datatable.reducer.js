...
var MuiDatatableReducer = function (state, _a) {
    var action = _a.action, payload = _a.payload;
    switch (action) {
        case MuiDatatableAction.UpdateColumns: {
            return __assign(__assign({}, state), { columns: (payload === null || payload === void 0 ? void 0 : payload.columns) || [], columnVisibilityChoices: (payload === null || payload === void 0 ? void 0 : payload.columnVisibilityChoices) || [], visibleColumns: (payload === null || payload === void 0 ? void 0 : payload.visibleColumns) || [] });
        }
